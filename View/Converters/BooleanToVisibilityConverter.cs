...
{
    /// <summary>
    /// Конвертер, преобразующий значение типа <see cref="bool"/> в значение перечисления <see cref="Visibility"/>.
    /// </summary>
    public class BooleanToVisibilityConverter : IValueConverter
    {
        ...
        /// </summary>
        /// <param name="value">Значение типа <see cref="bool"/>, которое необходимо преобразовать.</param>
        ...
        /// <returns>
        /// Возвращает <see cref="Visibility.Visible"/>, если значение <paramref name="value"/> равно <c>true</c>,
        ...
        /// </summary>
        /// <param name="value">Значение типа <see cref="Visibility"/>, которое необходимо преобразовать обратно.</param>
        /// <param name="targetType">Тип целевого свойства (не используется).</param>
        /// <param name="parameter">Дополнительный параметр (не используется).</param>
        /// <param name="culture">Культура (не используется).</param>
        /// <returns>
        /// Метод не реализован и всегда выбрасывает исключение <see cref="NotImplementedException"/>.
        /// </returns>
